                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  Padding(
                                    ...
                                    child: Text('${schedules[schedulesIndex].day.toUpperCase()}',style: TextStyle(fontSize: 18,color: Colors.deepOrange,fontWeight: FontWeight.bold),),
                                  ),
                                  ListView.builder(
                                          shrinkWrap: true,
                                          physics: NeverScrollableScrollPhysics(),
                                          itemCount: schedules[schedulesIndex].subjects.length,
                                          itemBuilder: (context, subjectsIndex) => Padding(
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          children: <Widget>[
                                                            ...
                                                            Text('${schedules[schedulesIndex].subjects[subjectsIndex].subject}',style: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.bold),)
                                                          ],
                                                        ),
                                                      ),
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          children: <Widget>[
                                                            ...
                                                            Text('${schedules[schedulesIndex].subjects[subjectsIndex].time}',style: TextStyle(fontSize: 14,color: Colors.black),)
                                                          ],
                                                        ),
                                                      ),
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          children: <Widget>[
                                                            ...
                                                            Text('${schedules[schedulesIndex].subjects[subjectsIndex].teacherOrClass}',style: TextStyle(fontSize: 14,color: Colors.black))
                                                          ],
                                                        ),
                                                      )
                                                    ],
